...
Highcharts.chart('container', {
    ...
    yAxis: {
    	allowDecimals:false, //no decimales
        title: {
            text: null
        },
        labels: {
        	  formatter: function () {
                return Math.abs(this.value);//quitamos %
            }
        },
        accessibility: {
    ...
    tooltip: {
      ...
      formatter: function () {
            return '<b>' + this.series.name + ', edad ' + this.point.category + '</b><br/>' +
                'Cantidad: ' + Highcharts.numberFormat(Math.abs(this.point.y), 0) + ' personas';
        }
...
require_once("php/database.php");
         ...
         $edadesM = listarEdad($con,"M");
		 $edadesF = listarEdad($con,"F");
          ?>

    series: [{
        name: 'Hombre',
        data: [  <?php   foreach($edadesM as $edad){ 
		echo "-".$edad['16-19'].","; 
		echo "-".$edad['20-29'].","; 
		echo "-".$edad['30-39'].","; 
		echo "-".$edad['+40'].","; 
        ...
        name: 'Mujer',
        data: [ <?php   foreach($edadesF as $edad)
		{ 
		echo "-".$edad['16-19'].","; 
		echo "-".$edad['20-29'].","; 
		echo "-".$edad['30-39'].","; 
