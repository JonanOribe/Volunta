...
<body>
    <div class="wrapper">
      ...
      require_once("./php/database.php");
          ...
          echo "<h3>LISTADO LOCALIZACIONES</h3>";
          
                     
         $localizaciones = listarLocalizaciones($con);
          
          if(count($localizaciones) == 0){
              echo "<br/>No hay localizaciones<br/>";
          }
          else{
              
              foreach($localizaciones as $localizacion){
                  echo "<tr>
                          <td>".$localizacion['idlugar']."</td>
