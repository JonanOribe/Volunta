...
<link rel="stylesheet" href="./style/calendarioPrincipal.css">
</head>
...
<body>
    ...
    <div id="right">
        <div id="menu">
            <span class="dropdown" id="dropdownCalendar">
            ...
            <span id="menu-navi">
                ...
                <button type="button" class="btn btn-default btn-sm move-day" data-action="move-prev">
                    <i class="calendar-icon ic-arrow-line-left" data-action="move-prev">Semana previa</i>
                </button>
                <button type="button" class="btn btn-default btn-sm move-day" data-action="move-next">Siguiente semana
